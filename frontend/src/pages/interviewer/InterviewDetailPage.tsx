        ...
        <div className="bg-white shadow rounded-lg dark:bg-gray-800">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            ...
            {interview.skeleton.description && (
              <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">{interview.skeleton.description}</p>
            )}
          </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <textarea
                        ...
                        className={`mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-indigo-600 dark:focus:border-indigo-600 ${isFieldInvalid(area.title, 'feedback') ? 'border-red-300 dark:border-red-700' : ''}`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`mt-1 block w-24 border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-indigo-600 dark:focus:border-indigo-600 ${isFieldInvalid(area.title, 'rating') ? 'border-red-300 dark:border-red-700' : ''}`}
                        required
                      />
