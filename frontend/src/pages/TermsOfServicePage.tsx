        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="flex items-start">
              <UserIcon className="h-6 w-6 text-indigo-600 mr-3 mt-1 flex-shrink-0" />
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">2. Accounts & Access</h2>
            <p className="text-gray-600 mb-4">To use certain features, users must create an account. You agree to:</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="border border-red-200 rounded-lg p-4 bg-red-50">
                <p className="text-sm text-red-800">Provide false, misleading, or fraudulent information.</p>
              </div>
              <div className="border border-red-200 rounded-lg p-4 bg-red-50">
                <p className="text-sm text-red-800">Post or share any content that is defamatory, obscene, abusive, or discriminatory.</p>
              </div>
              <div className="border border-red-200 rounded-lg p-4 bg-red-50">
                <p className="text-sm text-red-800">Interfere with the security, integrity, or performance of the platform.</p>
              </div>
              <div className="border border-red-200 rounded-lg p-4 bg-red-50">
                <p className="text-sm text-red-800">Use the platform to distribute malware, spam, or unsolicited messages.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. Use of the Platform</h2>
            <p className="text-gray-600 mb-4">Our ATS is designed to:</p>
            <div className="grid md:grid-cols-2 gap-4 mb-4">
              <div className="border border-green-200 rounded-lg p-4 bg-green-50">
                <p className="text-sm text-green-800">Help employers manage recruitment and hiring processes.</p>
              </div>
              <div className="border border-green-200 rounded-lg p-4 bg-green-50">
                <p className="text-sm text-green-800">Allow job seekers to apply for and track job opportunities.</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. AI-Powered Features</h2>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-400 p-4">
              <div className="flex">
                ...
                <div>
                  <h4 className="text-sm font-medium text-amber-800">AI Limitation Notice</h4>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600">
              We collect and process user data in accordance with our <a href="/privacy-policy" className="text-indigo-600 hover:text-indigo-500 underline">Privacy Policy</a>, which forms part of these Terms. By using the platform, you consent to the collection, use, and sharing of your data as described.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-4">We may suspend or terminate your account at any time if:</p>
            <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-4">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-4">The platform is provided "as is" without warranties of any kind. We do not guarantee:</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 mb-4">To the fullest extent permitted by law, IST Africa Ltd is not liable for:</p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="border border-yellow-200 rounded-lg p-4 bg-yellow-50">
                <p className="text-sm text-yellow-800">Indirect or consequential damages.</p>
              </div>
              <div className="border border-yellow-200 rounded-lg p-4 bg-yellow-50">
                <p className="text-sm text-yellow-800">Loss of employment opportunities.</p>
              </div>
              <div className="border border-yellow-200 rounded-lg p-4 bg-yellow-50">
                <p className="text-sm text-yellow-800">AI-related inaccuracies or decisions.</p>
              </div>
              <div className="border border-yellow-200 rounded-lg p-4 bg-yellow-50">
                <p className="text-sm text-yellow-800">Data breaches by third-party service providers.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-2 text-gray-600">
                <p><strong>Email:</strong> <a href="mailto:support@istlegal.rw" className="text-indigo-600 hover:text-indigo-500 underline">support@istlegal.rw</a></p>
                <p><strong>Phone:</strong> <a href="tel:+250782371420" className="text-indigo-600 hover:text-indigo-500">+250782371420</a></p>
