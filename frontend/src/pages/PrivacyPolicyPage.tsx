      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl py-8">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">1. Scope</h2>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">2. Data We Collect</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">We collect the following categories of personal data:</p>
            <ul className="space-y-3 text-gray-600 dark:text-gray-300">
              <li className="flex items-start">
                <span className="bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-300 text-xs font-medium px-2.5 py-0.5 rounded mr-3 mt-1">Identity</span>
                Name, date of birth, gender.
              </li>
              <li className="flex items-start">
                <span className="bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 text-xs font-medium px-2.5 py-0.5 rounded mr-3 mt-1">Contact</span>
                Email address, telephone number, physical address.
              </li>
              <li className="flex items-start">
                <span className="bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300 text-xs font-medium px-2.5 py-0.5 rounded mr-3 mt-1">Employment</span>
                CV/resume details, education history, employment history, references, certifications.
              </li>
              <li className="flex items-start">
                <span className="bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300 text-xs font-medium px-2.5 py-0.5 rounded mr-3 mt-1">System</span>
                IP address, browser information, usage logs, and device information.
              </li>
              <li className="flex items-start">
                <span className="bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-200 text-xs font-medium px-2.5 py-0.5 rounded mr-3 mt-1">Optional</span>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">3. Purpose of Data Collection</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">We collect and process your personal data for the following purposes:</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">4. Lawful Basis for Processing</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">We process personal data based on:</p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Consent</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">When creating an account or submitting a job application.</p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Contractual Necessity</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Managing your recruitment process.</p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Legitimate Interest</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Improving platform performance or analytics.</p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Legal Obligation</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Retention of records under labor laws.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">5. AI Usage and Disclaimer</h2>
            <div className="bg-amber-50 dark:bg-yellow-900/30 border-l-4 border-amber-400 dark:border-amber-500 p-4 mb-4">
              <div className="flex">
                ...
                <div>
                  <h4 className="text-sm font-medium text-amber-800 dark:text-amber-200">Important Notice</h4>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">6. Data Sharing and Disclosure</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">We may share your personal data with:</p>
            ...
            <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-4">
              <p className="text-green-800 dark:text-green-300 font-medium">We do not sell personal data to third parties.</p>
            </div>
          </div>

          {/* Section 7: International Transfers */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">7. International Data Transfers</h2>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">9. Your Rights</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">Under Rwanda's data protection law, you have the right to:</p>
            <div className="grid md:grid-cols-2 gap-3">
              <div className="flex items-center text-gray-600 dark:text-gray-300">
                <ShieldCheckIcon className="h-4 w-4 text-green-500 dark:text-green-400 mr-2" />
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">10. Data Security</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">We implement robust technical and organizational security measures including:</p>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-center text-gray-600 dark:text-gray-300">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">11. Children's Data</h2>
            <p className="text-gray-600 dark:text-gray-300">
          ...
          {/* Section 12: Changes */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-4">12. Changes to this Privacy Policy</h2>
            <p className="text-gray-600 dark:text-gray-300">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-6">
              ...
              <div className="space-y-2 text-gray-600 dark:text-gray-300">
                <p><strong>Email:</strong> <a href="mailto:privacy@istlegal.rw" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 underline">privacy@istlegal.rw</a></p>
                <p><strong>Phone:</strong> <a href="tel:0782371420" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">0782371420</a></p>
