...
const LandingPage: React.FC = () => {
  ...
  const content = (
    <div className="bg-white" style={{ scrollBehavior: 'smooth' }}>
      {/* Hero Section */}
      <div id="about" className="relative bg-gradient-to-r from-indigo-50 to-blue-50">
      ...
      {/* Testimonial */}
      <div id="contact" className="bg-indigo-700 py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                <li>
                  <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-base text-gray-300 hover:text-white">
                    Privacy Policy
                  </a>
                </li>
                <li>
                  <a href="/terms-of-service" target="_blank" rel="noopener noreferrer" className="text-base text-gray-300 hover:text-white">
                    Terms of Service
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <div className="mt-4 flex space-x-6">
                ...
                {/* LinkedIn - Active */}
                <a href="https://www.linkedin.com/company/ist-africa/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-300">
